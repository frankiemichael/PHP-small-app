...
$sql = "SELECT * FROM trereife_products";
...
<td><input class='data' name='product_sku' style="width:100%;" value='<?php echo $result['product_sku']; ?>'></input></td>
<td data-category="parentid"><select class='data' name='parentid' class="form-control" id="parentid">
     <option value="0">None</option>
     <?php
     $sql2 = "SELECT * FROM trereife_categories ORDER BY cat_name";
