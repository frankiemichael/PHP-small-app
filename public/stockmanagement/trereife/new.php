...
include('../../../inc/db_connect.php');
 ...
 <div id='parent' class="form-group">
   ...
   <select name='parentid' class="form-control" id="parentid">
     ...
     <?php
     $sql = "SELECT * FROM trereife_categories WHERE cat_parentid = '0' ORDER BY cat_name";
...
$('#productOrFolder').on('change', function(){
  if ($(this).val() == 0) {
    ...
    $('#name').after("<div class='form-group'><label for='name'>SKU</label><input type='text' class='form-control' name='sku' required></div>")
    $('#subcategorydiv').show()
